...
class Starfield: SCNView
{
    ...
    func Show(StarCount: Int = 1000, StarColor: UIColor = UIColor.white, UseNaturalStarColors: Bool = false,
    ...
    func FillStars(To Count: Int, MaxSize: Double = 0.08, StarColor: UIColor = UIColor.white,
                  ...
                  UseNaturalStarColors: Bool = false)
    {
        ...
        Node.runAction(Group)
        {
            ...
            self.MakeStar(StarColor: UIColor.white, SpeedMultiplier: SpeedMultiplier,
