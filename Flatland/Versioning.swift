...
//  Versioning.swift
//  BlockCam
//  Adapted from Fouris, GPS Log, and BlockCam, May 2020
//
...
public class Versioning: CustomStringConvertible
{
    ...
    public static let ApplicationName = "Flatland"
    
    /// Tag for the application.
    public static let Tag: String = "Beta"
    
    /// ID of the application.
    public static let ProgramID = "436895d1-b3a4-4ebb-8ace-b4cfc76b737a"
    ...
    public static func VerySimpleVersionString(ExcludePrefix: Bool = false) -> String
    {
        if ExcludePrefix
        {
    ...
    /// Build number.
    public static let Build: Int = 1206
    
    /// Build increment.
    private static let BuildIncrement = 1
    
    /// Build ID.
    public static let BuildID: String = "4717A94C-7E79-4517-BDD9-FADB0A8F5FCA"
    
    /// Build date.
    public static let BuildDate: String = "27 May 2020"
    
    /// Build Time.
    public static let BuildTime: String = "16:37"
    ...
    /// Returns a formatted list of copyright years.
    /// - Returns: String of list of copyright years.
    public static func FormattedCopyrightYears() -> String
    {
        var Years = Versioning.CopyrightYears
        var CopyrightYears = ""
        if Years.count > 1
