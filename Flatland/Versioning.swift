...
public class Versioning: CustomStringConvertible
{
    ...
    /// Build number.
    public static let Build: Int = 1092
    
    /// Build increment.
    private static let BuildIncrement = 1
    
    /// Build ID.
    public static let BuildID: String = "FB67E32C-6513-4B6C-8803-73E7B3A17435"
    
    /// Build date.
    public static let BuildDate: String = "20 May 2020"
    
    /// Build Time.
    public static let BuildTime: String = "21:04"
