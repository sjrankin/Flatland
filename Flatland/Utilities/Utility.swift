...
class Utility
{
    ...
    /// Convert the device's current orientation into a string.
    ///
    /// - Returns: Orientation of the device as an English-language string.
    public static func GetOrientationName() -> String
    {
        switch UIDevice.current.orientation
        {
            ...
            @unknown default:
            fatalError("Uknown enum returned.")
        }
    }
