...
class SunGenerator
{
    ...
    func VariableSunImage(Using View: UIImageView, Interval: Double = 0.1, Radius: Float = 40.0)
    {
        VariableView = View
    ...
    func SunImage(WithStrength: Float) -> UIImage
    {
    ...
    /// - Returns: Image of a sun.
    func SunImage(WithStrength: Float, UseColor: UIColor) -> UIImage
    {
    ...
    /// - Returns: Image of a sun.
    func SunImage(WithStrength: Float, WithRadius: Float) -> UIImage
    {
    ...
    /// - Parameter WithRadius: The radius of the sun.
    /// - Returns: Image of a sun.
    func SunImage(WithStrength: Float, UseColor: UIColor, WithRadius: Float) -> UIImage
    {
    ...
    /// - Parameter WithRadius: The radius of the sun.
    /// - Returns: Image of a sun.
    func SunImage(WithRadius: Float) -> UIImage
    {
